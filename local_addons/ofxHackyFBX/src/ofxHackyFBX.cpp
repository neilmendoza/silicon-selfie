...
ofxHackyFBX::ofxHackyFBX(const char * pFileName, int pWindowWidth, int pWindowHeight, bool pSupportVBO)
...
mWindowWidth(pWindowWidth), mWindowHeight(pWindowHeight), mDrawText(new DrawText)
{
   ...
   if (mSdkManager)
   {
       ...
       if(mImporter->Initialize(ofToDataPath(mFileName, true).c_str(), lFileFormat) == true)
       {
...
bool ofxHackyFBX::SetCurrentAnimStack(int pIndex)
{
...
bool ofxHackyFBX::SetCurrentCamera(const char * pCameraName)
{
    if (!pCameraName)
    {
        return false;
...
bool ofxHackyFBX::SetCurrentPoseIndex(int pPoseIndex)
{
...
void ofxHackyFBX::OnTimerClick() const
{
...
void ofxHackyFBX::OnReshape(int pWidth, int pHeight)
{
...
void ofxHackyFBX::OnKeyboard(unsigned char pKey)
{
...
void ofxHackyFBX::SetSelectedNode(FbxNode * pSelectedNode)
{
    mSelectedNode = pSelectedNode;
    mStatus = MUST_BE_REFRESHED;
}

void ofxHackyFBX::SetShadingMode(ShadingMode pMode)
{
    mShadingMode = pMode;
    mStatus = MUST_BE_REFRESHED;
}

void ofxHackyFBX::DisplayWindowMessage()
{
...
void ofxHackyFBX::DisplayGrid(const FbxAMatrix & pTransform)
{
    glPushMatrix();
...
void ofxHackyFBX::SetZoomMode( CameraZoomMode pZoomMode)
{
